...
public class BBrenderer {
	...
	private BoundingBoxInfo bb;

	
	
	
	public BBrenderer(Loader loader ,BoundingBoxInfo bb,Matrix4f projection){
		//loader = new Loader();
		this.bb = bb;
	...
	public void renderer(Camera camera) {
		...
		Matrix4f transformation = Maths.createTransformationMatrix(bb.getPosition(),0,0,0, bb.getScale());
